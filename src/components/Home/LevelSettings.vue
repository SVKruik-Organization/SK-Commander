    ...
    <div class="content-container">
        <section class="settings-item">
            ...
            <div class="input-container">
                ...
                <div class="input-wrapper">
                    <input type="number" class="shadow input" id="levelRolePosition"
            ...
            <div class="input-container">
                ...
                <div class="input-wrapper">
                    <input type="number" class="shadow input" id="levelRoleMax" @change="this.change('save-levelRoleMax')">
            ...
            <div class="input-container">
                ...
                <div class="input-wrapper">
                    <input type="text" class="shadow input" id="levelRoleColor"
            ...
            <div class="input-container">
                <p class="input-label text-shadow">Active</p>
                <div class="input-wrapper">
                    <div class="select-wrapper shadow input">
                        <select id="levelRoleEnable" @change="this.change('save-levelRoleEnable')">
        ...
        <section class="settings-item">
            ...
            <div class="input-container">
                ...
                <div class="input-wrapper">
                    <input type="number" class="shadow input" id="rewardNormalMessage"
                        @change="this.change('save-rewardNormalMessage')">
            ...
            <div class="input-container">
                ...
                <div class="input-wrapper">
                    <input type="number" class="shadow input" id="rewardSlashMessage"
            ...
            <div class="input-container">
                ...
                <div class="input-wrapper">
                    <input type="number" class="shadow input" id="rewardPurchase"
